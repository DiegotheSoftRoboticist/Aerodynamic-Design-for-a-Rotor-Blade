...
for m =1:length(TSR_cp)
  Cp_final(m) = (8/(TSR_cp(m)*20))*sum(Cp(:,m));
end 
...
R = 67.1055;     %rotor radio in meters.
...
p_plot=[0,0,P_max(1:18),6562683.95,0]
figure(3)
...
table222=[Umax P_max'/10^6 Omega_RPM_max']
